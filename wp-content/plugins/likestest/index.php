...
class LikesTest {
	...
	public function likestest_shortcode( $atts ): void {
		if ( ! isset( $atts['post_id'] ) ) {
			return;
		}

		$likes_count = $this->get_post_likes_count( $atts['post_id'] );
		?>
		<div class="c-likes js-likes">
			<button class="c-btn likes-plus" data-id="<?php echo esc_attr( $atts['post_id'] ) ?>">
			...
			<button class="c-btn likes-minus" data-id="<?php echo esc_attr( $atts['post_id'] ) ?>">
				<svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
